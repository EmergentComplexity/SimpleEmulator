...
SUB 0001 ; Subtract 2 inputed values, the first value entered is in address 1 and the second is still in the accumulator
OUT 0000 ; output the difference, the accumulator is written to the output register, 0000 because OUT doesnt need an operand
B   0000 ; unconditional jump to start of program, subtract 2 more numbers
